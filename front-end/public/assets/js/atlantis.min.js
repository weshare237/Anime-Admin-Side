...
function legendClickCallback(a) {
  for (
    var e = (a = a || window.event).target || a.srcElement;
    'LI' !== e.nodeName;
  ...
  $(document).ready(function () {
    ...
    if (!g) {
      ...
      $('.wrapper').hasClass('sidebar_minimize') &&
        ((v = 1),
        k.addClass('toggled'),
        k.html('<i className="icon-options-vertical"></i>')),
        k.on('click', function () {
          1 == v
            ? ($('.wrapper').removeClass('sidebar_minimize'),
              k.removeClass('toggled'),
              k.html('<i className="icon-menu"></i>'),
              (v = 0))
    ...
    $('.wrapper').hasClass('is-show') &&
      ((b = 1),
      y.addClass('toggled'),
      y.html('<i className="icon-options-vertical"></i>')),
      y.on('click', function () {
        1 == b
          ? ($('.wrapper').removeClass('is-show'),
            y.removeClass('toggled'),
            y.html('<i className="icon-menu"></i>'),
            (b = 0))
