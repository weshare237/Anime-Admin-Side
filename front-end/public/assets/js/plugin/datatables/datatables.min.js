...
!(function (t) {
  ...
  function d(e, n, r) {
    ...
    r !== a &&
      ...
      r.className && !r.sClass && (r.sclassName = r.className),
    ...
    ;(n._bAttrSrc =
      ...
      n.bSortable && (e || r)
        ? e && !r
          ? ((n.sSortingclassName = i.sSortableAsc),
            (n.sSortingClassJUI = i.sSortJUIAscAllowed))
          : !e && r
          ? ((n.sSortingclassName = i.sSortableDesc),
            (n.sSortingClassJUI = i.sSortJUIDescAllowed))
          : ((n.sSortingclassName = i.sSortable),
            (n.sSortingClassJUI = i.sSortJUI))
        : ((n.sSortingclassName = i.sSortableNone), (n.sSortingClassJUI = ''))
  }
  function h(t) {
  ...
  function H(e) {
    ...
    if (
      ...
      for (n = 0, a = (e = e.aoFooter[0]).length; n < a; n++)
        (i = f[n]), (i.nTf = e[n].cell), i.sClass && t(i.nTf).addClass(i.sClass)
  }
  function N(e, n, r) {
    var o,
      i,
      ...
      if (0 !== c.length)
        for (l = u ? e.aoData.length : f, u = u ? 0 : s; u < l; u++) {
          ...
          if ((null === h.nTr && P(e, d), (d = h.nTr), 0 !== i)) {
            var p = o[r % i]
            h._sRowStripe != p &&
              (t(d).removeClass(h._sRowStripe).addClass(p), (h._sRowStripe = p))
          }
  ...
  function q(e) {
    var a = e.oClasses,
      ...
      i = e.oPreviousSearch,
      l = e.aanFeatures,
      s = '<input type="search" className="' + a.sFilterInput + '"/>',
            ...
            b = function (n, a) {
              ...
              for (r = 0, i = a.length; r < i; r++)
                if (((S = a[r]), t.isArray(S)))
                  ...
                  switch (((u = null), (c = ''), S)) {
                    case 'ellipsis':
                      n.append('<span className="ellipsis">&#x2026;</span>')
                      break
                    case 'first':
                      ;(u = h.sFirst),
...
!(function (e) {
  ...
  return (
    ...
    (o.ext.renderer.pageButton.bootstrap = function (a, s, r, d, i, l) {
      ...
      w(e(s).empty().html('<ul className="pagination"/>').children('ul'), d),
        p !== n &&
          e(s)
            .find('[data-dt-idx=' + p + ']')
            .focus()
