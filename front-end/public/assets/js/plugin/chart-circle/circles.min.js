    ...
    b = function (a) {
      ...
      if (((this._el = document.getElementById(b)), null !== this._el)) {
        ;(this._radius = a.radius || 10),
          ...
          (this._wrpclassName = a.wrpClass || 'circles-wrp'),
          (this._textclassName = a.textClass || 'circles-text'),
          (this._valclassName = a.valueStrokeClass || 'circles-valueStroke'),
          (this._maxValclassName =
      ...
      _generateSvg: function () {
        return (
          ...
          this._generatePath(
            ...
            this._colors[0],
            this._maxValClass
          )._generatePath(1, !0, this._colors[1], this._valClass),
