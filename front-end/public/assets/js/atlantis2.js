...
$(document).ready(function () {
  ...
  if (!toggle_sidebar && $('.sidenav-toggler').length) {
    ...
    toggle.on('click', function () {
      if (nav_open == 1) {
        ...
        $('<div className="body-overlay"></div>').insertAfter('.nav-bottom')
  ...
  if (!toggle_sidebar2 && $('.sidenav-toggler2').length) {
    ...
    toggle.on('click', function () {
      if (nav_open == 1) {
        ...
        $('html').addClass('nav_open')
        $('<div className="body-overlay"></div>').insertAfter(
          '.page-navigation'
        )
        toggle.addClass('toggled')
        nav_open = 1
  ...
  if (!quick_sidebar_open) {
    ...
    toggle.on('click', function () {
      if (nav_open == 1) {
        ...
        toggle.addClass('toggled')
        $('<div className="quick-sidebar-overlay"></div>').insertAfter(
          '.quick-sidebar'
        )
  ...
  if (!minimize_sidebar) {
    ...
    if ($('.wrapper').hasClass('sidebar_minimize')) {
      ...
      minibutton.html('<i className="icon-options-vertical"></i>')
    }
    ...
    minibutton.on('click', function () {
      if (mini_sidebar == 1) {
        ...
        minibutton.html('<i className="icon-menu"></i>')
        mini_sidebar = 0
      } else {
